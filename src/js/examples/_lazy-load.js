...
/*
  Lazy, or "on demand", loading is a great way to optimize
  your site or application. This practice involves splitting your code
  at logical breakpoints, and then loading it once the user has done
  something that requires, or will require, a new block of code.

  This speeds up the initial load of the application and
...
console.log(
  `%c Open the Network Tab and click the Mixpack image logo
  at the top to test lazy loading.`,
