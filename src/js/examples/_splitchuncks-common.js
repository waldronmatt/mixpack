...
/*
  Webpack will generate a common.js file because
  both app.js and another-entry.js
...
const splitchuncksCommon = () => {
  ...
  console.log(
    `Webpack will generate a commons.js file because this module
    is shared by multiple entrypoints (chuncks).`
  );
};

export default splitchuncksCommon;
