module.exports = {
  ...
  extends: [
    /*
      ...
      Turns on additional rules to enforce the common stylistic
      conventions found within a handful of CSS styleguides,
    ...
    */
    ...
    /*
      This linter has been designed / tested with SCSS syntax based on the
      SCSS guidelines documented in https://sass-guidelin.es/
    */
  ...
  plugins: [
    ...
    'stylelint-order',
    /*
      a collection of SCSS specific linting rules for
      stylelint (in a form of a plugin).
    */
    'stylelint-scss',
    /*
